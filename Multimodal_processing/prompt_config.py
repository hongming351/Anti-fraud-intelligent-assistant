...
###示例19：日常情侣对话（安全）—— 解决图片白样本误判
【输入】文本：08:43 起来了吗？化妆呢。你挺快啊。你早上吃没吃饭？见你的路上都是跑着的。没有...
【输出】{
"risk_level": "safe",
"fraud_type": "无诈骗",
"confidence": 0.99,
"suspicious_keywords": [],
"reason": "情侣之间的日常问候，内容为起床、化妆、吃饭等生活话题，无任何诈骗特征。",
"advice": "✅【安全】这是正常的社交聊天，可放心回复。"
}

###示例20：朋友约饭（安全）—— 解决图片白样本误判
【输入】文本：13:28 周先生，什么时候回来？今天晚上到家。晕，我明天晚上去北京，晚上要不请你吃饭吧？我晚上都十二点左右到家，怎么了？那我回来再请你吃饭吧。
【输出】{
"risk_level": "safe",
"fraud_type": "无诈骗",
"confidence": 0.99,
"suspicious_keywords": [],
"reason": "朋友之间约饭的对话，讨论回家时间和聚餐安排，无诈骗特征。",
"advice": "✅【安全】正常社交对话。"
}

###示例21：工作沟通（安全）—— 解决音频白样本误判
【输入】文本：项目进度怎么样了？需求文档已经写完，下午发给您审核。好的，记得把测试用例也一起附上。收到，马上补充。
【输出】{
"risk_level": "safe",
"fraud_type": "无诈骗",
"confidence": 0.98,
"suspicious_keywords": [],
"reason": "正常的工作沟通，讨论项目进度、文档提交和测试用例，无诱导转账或虚假信息。",
"advice": "✅【安全】正常工作交流。"
}

###示例22：闲鱼“假一赔三”诈骗（高危）—— 解决图片黑样本漏判
【输入】文本：闲鱼在线客服：您好，假一赔三开通需要缴纳4850元，开通完成2分钟内退还您资金加上刚刚的2000元，并退回您6850元。无需扣留。
【输出】{
"risk_level": "high",
"fraud_type": "冒充客服诈骗",
"confidence": 0.97,
"suspicious_keywords": ["假一赔三", "缴纳", "开通", "退还资金"],
"reason": "典型冒充客服诈骗：(1)假借“假一赔三”名义要求缴费；(2)声称开通后会退款，实则骗取钱财；(3)诱导用户转账。",
"advice": "🚨【紧急】正规平台不会要求缴纳“假一赔三”开通费。这是诈骗，请立即停止交易并举报。"
}

###示例23：支付宝退款链接诈骗（高危）—— 解决图片黑样本漏判
【输入】文本：支付宝退款链接 http://fake.com/refund 请点击进入，按照流程退款。输入您的淘宝或支付宝帐号，填写您退款的银行信息，按步骤确认退款。
【输出】{
"risk_level": "high",
"fraud_type": "冒充客服退款诈骗",
"confidence": 0.98,
"suspicious_keywords": ["退款链接", "点击进入", "填写银行信息"],
"reason": "典型的退款诈骗：(1)发送虚假退款链接；(2)诱导填写银行账号和密码；(3)最终盗刷资金。",
"advice": "🚨【紧急】不要点击陌生退款链接！退款应通过官方APP操作。切勿泄露银行卡信息。"
}

###示例24：投资理财“内部消息”诈骗（高危）—— 解决音频黑样本漏判
【输入】文本：内部消息，国家新能源项目日收益5%，保本保息。下载碳汇宝APP充值即可参与，名额有限，加微信lc888领取名额。
【输出】{
"risk_level": "high",
"fraud_type": "投资理财诈骗",
"confidence": 0.96,
"suspicious_keywords": ["内部消息", "日收益5%", "保本保息", "下载APP", "充值"],
"reason": "典型虚假投资理财诈骗：(1)虚构“内部消息”制造稀缺感；(2)承诺远超市场正常水平的日收益（5%极度不合理）；(3)宣称保本保息（违反金融常识）；(4)诱导下载非官方APP充值。",
"advice": "🚨【紧急】日收益5%是典型的庞氏骗局！请勿充值，立即删除APP。正规投资不会保本保息。"
}
